...
extension Tagged where RawValue == Ordinal, Tag: ~Copyable {
    /// `Index<Tag>.Cyclic<N>` = `Tagged<Tag, Cyclic.Group.Static<N>.Element>`
    ///
...
extension Tagged where Tag: ~Copyable {
    ...
    where RawValue == Cyclic_Primitives.Cyclic.Group.Static<N>.Element {
        self.init(__unchecked: (), try Cyclic_Primitives.Cyclic.Group.Static<N>.Element(position))
    }
    ...
    where RawValue == Cyclic_Primitives.Cyclic.Group.Static<N>.Element {
        self.init(__unchecked: (), Cyclic_Primitives.Cyclic.Group.Static<N>.Element(__unchecked: position))
    }
}
...
extension Tagged where Tag: ~Copyable {
    ...
    where RawValue == Cyclic_Primitives.Cyclic.Group.Static<N>.Element {
        ...
        self.init(__unchecked: (), try Cyclic_Primitives.Cyclic.Group.Static<N>.Element(Ordinal(UInt(position))))
    }
    ...
    where RawValue == Cyclic_Primitives.Cyclic.Group.Static<N>.Element {
        self.init(__unchecked: (), Cyclic_Primitives.Cyclic.Group.Static<N>.Element(__unchecked: Ordinal(UInt(position))))
    }
}
